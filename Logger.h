...
#define LOG(level) alphaposeTrtLoger::LogTransaction(allogger, alphaposeTrtLoger::level, __FILE__, __LINE__, __FUNCTION__).GetStream()

// TODO: properly re-programming this file, the lazy evaluation stream , next step would probably using log library instead of code from scratch.
// When opensource, delete this and the above line !!!
